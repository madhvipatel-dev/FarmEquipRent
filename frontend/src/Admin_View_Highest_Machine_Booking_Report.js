...
function Admin_View_Highest_Machine_Booking_Report() {
    ...
    async function getmachinerydetail() {
        const result = await fetch("http://localhost:5000/getmachineryhighestbookingdetail")
        const res = await result.json();
        res.sort((a, b) => b.totalbooking - a.totalbooking);
...
export default Admin_View_Highest_Machine_Booking_Report;
...
function Farmer_View_All_Booking() {
    ...
    async function getallbookingdetail() {
        const result = await fetch(`http://localhost:5000/getallbookingdetail/${farmerid}`);
        ...
        <>
            <div classNameNam="contact">
                <div className="container">
                    <h3 className="title">VIEW ALL BOOKING DETAIL</h3>
...
export default Farmer_View_All_Booking;